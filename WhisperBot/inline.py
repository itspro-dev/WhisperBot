...
main = [
    InlineQueryResultArticle(
        ...
        url="https://t.me/animefansclubchat",
        description="Write Target User's @username or id at the end of your message.",
        thumb_url="https://telegra.ph/file/4db5c5a2bb9fbbe43ed1b.jpg",
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Learn More", url="https://t.me/prowsprbot?start=start")],
